...
function draw() {
  ...
  for (let tree of trees) {
    // Ствол
    fill(101, 67, 33);
    rect(tree.x - tree.width / 2, tree.y - tree.height, tree.width, tree
    .height);

    // Крона
    fill(34, 139, 34);
    ellipse(tree.x, tree.y - tree.height - 20, tree.width * 2, tree.width *
    1.5);
    ellipse(tree.x - 15, tree.y - tree.height - 5, tree.width * 1.5, tree
      .width * 1.2);
    ellipse(tree.x + 15, tree.y - tree.height - 5, tree.width * 1.5, tree
      .width * 1.2);
  }
